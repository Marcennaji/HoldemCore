...
class ISPObjectFactory
{
  public:
    ...
    {
        static_assert(std::is_constructible_v<StateType, const GameEvents&, std::shared_ptr<HasLogger>>, 
                     "StateType must have constructor accepting GameEvents and HasLogger");
    ...
    {
        static_assert(std::is_constructible_v<StrategyType, std::shared_ptr<HasLogger>, std::shared_ptr<HasRandomizer>>, 
                     "StrategyType must have constructor accepting HasLogger and HasRandomizer");
    ...
    std::shared_ptr<HasLogger> getLoggerService() const {
        return m_adapter.createLoggerService();
    }
    
    std::shared_ptr<HasRandomizer> getRandomizerService() const {
        return m_adapter.createRandomizerService();
    }
    
    std::shared_ptr<HasHandEvaluationEngine> getHandEvaluationEngineService() const {
