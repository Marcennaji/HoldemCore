...
{
  public:
    PlayerFactory(const GameEvents& events, StrategyAssigner* assigner, pkt::core::Logger& logger,
                  pkt::core::HandEvaluationEngine& handEvaluator, pkt::core::PlayersStatisticsStore& statisticsStore,
                  pkt::core::Randomizer& randomizer);

    virtual ~PlayerFactory() = default;

    virtual std::shared_ptr<Player> createPlayer(int id, TableProfile profile, int startMoney);
