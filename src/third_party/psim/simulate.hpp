...
struct Hand
{
    Hand(CardMask firstHoleCard, CardMask secondHoleCard, CardMask common, int size)
        : firstHoleCard(firstHoleCard), secondHoleCard(secondHoleCard), common(common), size(size)
    {
...
void SimSdMulti(const Hand& shand, SimResults* results, size_t boards, size_t hands, size_t numOpponents);
