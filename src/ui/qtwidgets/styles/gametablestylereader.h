...
class GameTableStyleReader : public QObject
{
  ...
  public:
    ...
    QString getPlayerCashTextColor() const { return PlayerCashTextColor; }

    QString getPlayerNameLabelFontSize() const { return playerNameLabelFontSize; }

    QString getPlayerCashLabelFontSize() const { return cashFontSize; }

    QString getFont2String() const { return font2String; }

    QString getFont1String() const { return font1String; }
    ...
    // set pictures
    void setTableBackground(GameTableWindow*);
    ...
    void setWindowsGeometry(GameTableWindow*);
